...
| [Quantum Launcher](https://github.com/Mrmayman/quantumlauncher) | A simple, powerful Minecraft launcher written in Rust | Mrmayman | Rust based Launcher with mod support. Screenshots all seem to be from Mac OS, but there's a build for each 3 major OS type (Mac, Windows, Linux). **Very minimalist**. |
