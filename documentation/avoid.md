...
| Name | Incompatibilities | Version | Client / Server | Notes |
| --- | :---: | :---: | :---: | :---: |
| [Extended Hotbar](https://modrinth.com/mod/extended-hotbar) | Unknown | 1.20.1, 1.20.4, 1.21.0-1.21.1 | Client | Caused UI issues on 1.20.1, requiring some users to click on an offset. |
| [Fractional GUI](https://modrinth.com/mod/fractionalgui) | Unknown | 1.18.2, 1.19.2-1.21.5 | Client | Custom scaling options (i.e: 0.75x) render *very* badly. Also unsupported since 1.21.6. |
...
| [Reese's Sodium Options](https://modrinth.com/mod/reeses-sodium-options) | Non-sodium rendering engines | 1.16.5+ | Client | Seems to cause crashes on very specific scenarios. If you just play on a vanilla SMP on latest, this mod is safe. |
| [ResourcePackCached](https://modrinth.com/mod/resourcepackcached) |  Unknown | 1.20.x - 1.21.x | Client | Also keeps around server packs from servers you've deleted/abandoned. |
